/*global history */
sap.ui.define([
		"com/bmsitalia/Release_ODA/controller/BaseController",
		...
		"sap/ui/Device",
		"com/bmsitalia/Release_ODA/model/formatter"
	], function (BaseController, JSONModel, History, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("com.bmsitalia.Release_ODA.controller.Master", {
			...
			onInit : function () {
				...
				this._oGroupFunctions = {
					Ztotmgg : function(oContext) {
						var iGrouper = oContext.getProperty('Ztotmgg'),
							key, text;
						if (iGrouper <= 20) {
							key = "LE20";
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.bmsitalia.Release_ODA.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Ztotmgg", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Ztotmgg", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
